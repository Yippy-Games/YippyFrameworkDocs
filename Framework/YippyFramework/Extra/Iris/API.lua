...
return function(Iris: Types.Iris)
	...
	local function wrapper(
		name: string
	): (arguments: Types.WidgetArguments?, states: Types.WidgetStates?) -> Types.Widget
	...
	Iris.SetColumnIndex = function(columnIndex: number)
		...
		ParentWidget.RowColumnIndex = math.floor(ParentWidget.RowColumnIndex / ParentWidget.InitialNumColumns)
			+ (columnIndex - 1)
	end
